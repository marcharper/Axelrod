...
from .meta import MetaMajority, MetaMinority, MetaWinner, MetaHunter, MetaRandom
strategies.extend((MetaHunter, MetaMajority, MetaMinority, MetaWinner, MetaRandom))
